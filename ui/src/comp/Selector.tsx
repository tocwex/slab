...
const OVERRIDE_PROPS = {
  ...
  styles: {
    control: (style: StylesBase, state: ControlProps<SelectorOption, true>) => ({
      ...style,
      backgroundColor: state.isDisabled ? "var(--color-gray-600)" : style.backgroundColor,
    }),
    singleValue: (style: StylesBase, state: SingleValueProps<SelectorOption, true>) => ({
      ...style,
      color: state.isDisabled ? "var(--color-white)" : style.color,
    }),
  ...
  theme: (theme: SelectTheme) => ({
    ...
    colors: {
      ...
      neutral40: "var(--color-gray-600)",
      neutral50: "var(--color-gray-600)",
      neutral60: "var(--color-gray-600)",
      neutral70: "var(--color-gray-600)",
      neutral80: "var(--color-white)",
      neutral90: "var(--color-white)",
      primary: "var(--color-white)",
      primary25: "var(--color-gray-600)",
      primary50: "var(--color-gray-600)",
      primary75: "var(--color-gray-600)",
    },
  }),
};
