...
export function UrbitIcon({primary, secondary, className}: IconProps): ReactNode {
  return (
    <svg fill="current" viewBox="0 0 1052 1052" className={`rounded-full border-white ${className}`}>
      <path
